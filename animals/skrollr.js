...
(function(window, document, undefined) {
    ...
    function Skrollr(options) {
        ...
        if (_isMobile) {
            ...
            _initMobile();
            _updateClass(
                documentElement, [SKROLLR_CLASS, SKROLLR_MOBILE_CLASS], [NO_SKROLLR_CLASS]
            );
        } else {
            _updateClass(
                documentElement, [SKROLLR_CLASS, SKROLLR_DESKTOP_CLASS], [NO_SKROLLR_CLASS]
            );
        }
    ...
    var _calcSteps = function(fakeFrame, actualFrame) {
        ...
        for (; skrollableIndex < skrollablesLength; skrollableIndex++) {
            ...
            if (beforeFirst || afterLast) {
                ...
                if (beforeFirst) {
                    _updateClass(
                        element, [SKROLLABLE_BEFORE_CLASS], [SKROLLABLE_AFTER_CLASS, SKROLLABLE_BETWEEN_CLASS]
                    );
                    ...
                    _updateClass(
                        element, [SKROLLABLE_AFTER_CLASS], [SKROLLABLE_BEFORE_CLASS, SKROLLABLE_BETWEEN_CLASS]
                    );
                ...
                if (skrollable.edge !== 0) {
                    _updateClass(
                        element, [SKROLLABLE_CLASS, SKROLLABLE_BETWEEN_CLASS], [SKROLLABLE_BEFORE_CLASS, SKROLLABLE_AFTER_CLASS]
                    );
                    skrollable.edge = 0;
                }
            }
